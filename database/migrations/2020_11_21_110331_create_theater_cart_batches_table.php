...
class CreateTheaterCartBatchesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('theater_cart_batches', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('theater_cart_batches');
    }
}
