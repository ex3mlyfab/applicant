    ...
    <div class="content">
        <div class="block block-fx-shadow pentacare-bg">
            <div class="block-header" style="background: rgb(51, 70, 128, 0.8)">
                <h3 class="block-title text-white">{{$nursecart->drug->name  }}</h3>
                <div class="block-option">
                    <a href="{{route('inpatient.index')}}" class="btn btn-primary"><i class="fa fa-door-open"></i> Go to Dashboard</a>
                    <a href="{{route('nursecart.index')}}" class="btn btn-primary"><i class="fa fa-arrow-alt-circle-left"></i> Go Back</a>
                </div>
                    ...
                    <div class="block-content block-content-full">
                        <div class="row no-gutters">
                            <div class="col-md-12">
                                ...
                                <h3 class="mr-2" style="font-size: 18px">{{$nursecart->drug->name}}</h3>
                            </div>
                        </div>
                                ...
                                <div class="row items-pus text-center">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <a href="javascript:void(0)" class="link-fx font-size-h3">
                                            <span class="badge badge-pill badge-warning">{{$nursecart->drug->reorder_level ?? ''}}</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
