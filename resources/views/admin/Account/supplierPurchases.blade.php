...
<div class="content">
    ...
    <h3 class="block-title"> Search purchases for {{ $supplier->name}}</h3>
    </div>
            ...
            <div class="block-header bg-city"></div>
                <div class="block-content block-content-full">
                    <div class="row">
                        ...
                        @php
                            $years = DB::table('supplier_purchases')->select(DB::raw('YEAR(created_at) AS year'))->distinct()->get();
                        @endphp
           ...
           <div class="table-responsive">
            <table class="table table-bordered table-striped table-vcenter js-dataTable-buttons">
                ...
                <tfoot class="bg-success-light">
                    ...
                    <th> ₦ {{number_format($results->sum('amount_paid'), 2, '.', ',')}}</th>
                </tfoot>
