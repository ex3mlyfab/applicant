                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <a class="btn btn-info pressed" href="{{route('tca.invoice', $item->id)}}"><i class="fa fa-money-bill-alt mr-2"></i>Prepare Invoice</a>


                                @elseif (($item->status =='invoice generated'))
                                    Not yet paid
                                @elseif (($item->status =='item paid'))
                                <a href="{{route('tca.edit', $item->id)}}" class="text-info">Record result  </a>
