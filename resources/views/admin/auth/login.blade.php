                ...
                <div class="bg-image" style="background-image: url('{{asset('backend')}}/assets/media/photos/photo6@2x.jpg');">
                    <div class="hero-static bg-white-95">
                                            ...
                                            <form class="js-validation-signin" action="{{route('admin.login')}}" method="POST">
                                                @csrf
                                                    <div class="py-3">
                                                        ...
                                                        <input type="email" class="form-control form-control-alt form-control-lg" id="login-username" name="email" placeholder="Username" value="{{old('email')}}">
                                                            @error('email')
                        ...
                        <div class="content content-full font-size-sm text-muted text-center">
                            <strong>Pentacare Hospital</strong> &copy; <span data-toggle="year-copy">2020</span>
                        </div>
                    </div>
                </div>
                <!-- END Page Content -->
