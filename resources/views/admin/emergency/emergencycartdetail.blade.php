    ...
    <div class="content">
        <div class="block block-fx-shadow pentacare-bg">
            <div class="block-header" style="background: rgb(51, 70, 128, 0.8)">
                <h3 class="block-title text-white">{{$emergencycart->drugModel->name  }}</h3>
                <div class="block-option">
                    <a href="{{route('inpatient.index')}}" class="btn btn-primary"><i class="fa fa-door-open"></i> Go to Dashboard</a>
                    <a href="{{route('emergencycart.index')}}" class="btn btn-primary"><i class="fa fa-arrow-alt-circle-left"></i> Go Back</a>
                </div>
                ...
                <div class="block block-bordered">
                    <div class="block-content block-content-full">
                        <div class="row no-gutters">
                            <div class="col-md-12">
                                ...
                                <h3 class="mr-2" style="font-size: 18px">{{$emergencycart->drugModel->name}}</h3>
                            </div>
                        </div>
                                ...
                                <div class="row items-pus text-center">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <a href="javascript:void(0)" class="link-fx font-size-h3">
                                            <span class="badge badge-pill badge-warning">{{$emergencycart->drugModel->reorder_level ?? ''}}</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="table-responsive pentacare-bg">
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                @foreach ($emergencycart->emergencyCartBatches as $item)
                                    <tr>
                                        <td>
                                            {{$loop->iteration}}
                                        </td>
                                        ...
                                        <td>
                                            {{$item->emergencyCart->drugModel->purchase_price}}
                                        </td>
                                        <td>
                                            {{$item->emergencyCart->drugModel->cost}}
                                        </td>
