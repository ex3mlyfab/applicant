 ...
 <div class="bg-body-light">
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            ...
            <a href="{{route('patient.create')}}" class="btn btnlg btn-outline-primary"><i class="fa fa-plus mr-1"></i>Add New Patient (Individual Account)</a>
            ...
            <table class="table table-bordered table-striped table-vcenter js-dataTable-buttons">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <img src="{{asset('backend')}}/images/avatar/{{$patient->avatar}}" alt="{{$patient->full_name}}" class="img-avatar img-avatar128">
